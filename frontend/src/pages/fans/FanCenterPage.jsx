...
import { Card, Tabs, Button, Row, Col, Statistic, Tag, Spin, Empty, Space, message, Progress, List, Input, Typography, Divider, Avatar } from 'antd';
import {
...
const FanCenterPage = () => {
  ...
  const currentFan = fans.find((f) => f.user_id === user?.id) || fans[0] || null;
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', maxWidth: 600, margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
            ...
            <Button type="text" size="small" icon={<LogoutOutlined style={{ color: 'rgba(255,255,255,0.5)' }} />} onClick={handleLogout} />
          </div>
        </div>
      </div>
