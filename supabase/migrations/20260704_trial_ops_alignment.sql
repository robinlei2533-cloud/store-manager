...
STABLE
AS $$
  SELECT sr.scanned_at::date AS scan_date, COUNT(*)::bigint
  FROM public.scan_records sr
  WHERE sr.scanned_at::date >= CURRENT_DATE - GREATEST(days_count - 1, 0)
  GROUP BY sr.scanned_at::date
  ORDER BY sr.scanned_at::date;
$$;
