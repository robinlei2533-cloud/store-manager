...
import FanEntryRedirect from './pages/login/FanEntryRedirect';


import FanCenterPage from './pages/fans/FanCenterPage';
import StoreOwnerPage from './pages/store-owner/StoreOwnerPage';
        ...
        <AntApp>
          <ErrorBoundary>
            ...
            <Routes>
              ...
              <Route path="/" element={<FanEntryRedirect />} />
